...
seperate pockets, such that nearby points become vulnerable, or are extensive
...
produces a probabity distribution over classes, where $\Delta^k$ is the
...
The softmax function is essentially a continous version of the one-hot-argmax
...
over classes by using these computed classwise weights as logits, which are
