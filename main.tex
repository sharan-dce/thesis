...
is because networks seem to be much more smoother in memorising mislabled points
than these analyses assume. The regions wrongly learnt by networks are much
larger in size, rendering a large amount of probability mass vulnerable. We also
discuss the idea that Lipschitzness might not be always advantageous.
